...
- `LeaderQuote` (a quote set large: home shows Marc Andreessen's "Software is eating the world." with the source linked and no photo, `HOME_QUOTE`; About shows Rohit's words with his small round photo, `FOUNDER`), `FaqList` (questions in native `<details>`, paired with `faqLd()`).
