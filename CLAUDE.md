...
- `LeaderQuote` (home: Rohit's quote, signed with a small round photo; data in `LEADER`), `FaqList` (questions in native `<details>`, paired with `faqLd()`).
