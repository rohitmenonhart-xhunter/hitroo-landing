...
const steps = [
  { title: 'Raise a ticket', desc: 'From the app, on any device, the moment you need help.', color: '#0a0a0a' },
  { title: 'We pick it up', desc: 'A first response within 24 hours — from the team that built it.', color: '#0a0a0a' },
  { title: 'We ship the fix', desc: 'Most tickets resolved and verified within 48 hours.', color: '#0a0a0a' },
  { title: 'You stay updated', desc: 'Live status, start to finish. No chasing customer care.', color: '#0a0a0a' },
];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="px-6 py-24 md:py-32 bg-[#fafafa] border-t border-[#e5e5e5]">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <Reveal delay={120}>
            <span className="eyebrow text-[#0a0a0a]">Service level</span>
            <h2 className="text-3xl md:text-5xl font-bold tracking-[-0.03em] text-[#0a0a0a] mt-3 leading-[1.05]">Fast, by default.</h2>
            <div className="flex items-center gap-12 mt-10">
              <div>
                <div className="text-5xl md:text-6xl font-bold tracking-tight text-[#0a0a0a]">24<span className="text-[#0a0a0a]">h</span></div>
                <div className="text-xs uppercase tracking-[0.12em] text-[#6b6b6b] mt-2">First response</div>
              </div>
              <div className="h-14 w-px bg-[#e5e5e5]" />
              <div>
                <div className="text-5xl md:text-6xl font-bold tracking-tight text-[#0a0a0a]">48<span className="text-[#0a0a0a]">h</span></div>
      ...
      <section className="px-6 py-24 md:py-32 border-t border-[#e5e5e5]">
        <div className="max-w-6xl mx-auto">
          <Reveal className="max-w-2xl mb-14">
            <span className="eyebrow text-[#0a0a0a]">How it works</span>
            <h2 className="text-3xl md:text-5xl font-bold tracking-[-0.03em] text-[#0a0a0a] mt-3 leading-[1.02]">Four steps, every time.</h2>
          </Reveal>
          <Reveal delay={100}>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-12 border-t border-[#e5e5e5] pt-12">
              {steps.map((s, i) => (
                <div key={s.title}>
                  ...
                  <h3 className="text-lg font-semibold text-[#0a0a0a] mt-2">{s.title}</h3>
                  <p className="text-sm text-[#4a4a4a] mt-1.5 leading-relaxed">{s.desc}</p>
                </div>
              ))}
            </div>
          </Reveal>
      ...
      <section className="px-6 py-32 md:py-40 bg-[#fafafa] border-t border-[#e5e5e5] text-center">
        <Reveal className="max-w-3xl mx-auto">
          <h2 className="text-4xl md:text-6xl font-bold tracking-[-0.03em] text-[#0a0a0a] leading-[1.0]">Build with a team that stays.</h2>
          <p className="text-lg text-[#4a4a4a] mt-6">Every project ships with the HITROO app and our support SLA.</p>
          <Link href="/contact" className="inline-flex items-center gap-2 bg-[#0a0a0a] text-white text-sm font-medium px-8 py-4 rounded-full shadow-[0_8px_24px_rgba(32,33,36,0.25)] hover:bg-black hover:-translate-y-0.5 transition-all mt-9">Start a Project <ArrowRight className="h-4 w-4" /></Link>
        </Reveal>
      </section>
