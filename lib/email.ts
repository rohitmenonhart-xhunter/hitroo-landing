...
const SITE = 'https://www.hitroo.com';
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" style="width:100%;max-width:560px;background:#ffffff;border:1px solid #ececf0;border-radius:24px;overflow:hidden;">
          <tr>
            <td style="font-size:0;line-height:0;padding:0;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr>
                <td width="25%" height="6" style="background:#2451FF;font-size:0;line-height:0;">&nbsp;</td>
          ...
          <tr>
            <td style="padding:42px 42px 38px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
              <div style="font-size:18px;font-weight:700;letter-spacing:-0.01em;color:#0A1633;margin:0 0 30px;">HITROO</div>

              <h1 style="margin:0 0 14px;font-size:28px;line-height:1.15;font-weight:700;letter-spacing:-0.02em;color:#0A1633;">${heading}</h1>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 32px;"><tr>
                <td align="center" bgcolor="#0A1633" style="border-radius:999px;">
              ...
              <p style="margin:0;font-size:14px;line-height:1.6;color:#5f6368;">
                Need us sooner? <a href="mailto:info@hitroo.com" style="color:#2451FF;text-decoration:none;font-weight:600;">info@hitroo.com</a>
                &nbsp;&middot;&nbsp; <a href="tel:+917550000805" style="color:#2451FF;text-decoration:none;font-weight:600;">+91&nbsp;7550000805</a>
              </p>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:28px 0 0;"><tr>
                <td style="border-top:1px solid #ececf0;padding-top:20px;">
                  <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 10px;"><tr>
                    <td width="11" style="font-size:0;"><div style="width:7px;height:7px;border-radius:9px;background:#2451FF;"></div></td>
                  ...
                  <p style="margin:0;font-size:13px;line-height:1.6;color:#9aa0a6;">
                    <strong style="color:#0A1633;">HITROO</strong> &mdash; Intelligence, Unbound<br/>
